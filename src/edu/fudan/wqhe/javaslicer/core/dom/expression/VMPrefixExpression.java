...
public class VMPrefixExpression extends VMExpression {
	private Operator operator;
	private VMExpression expression;
	

	public VMPrefixExpression(Expression node, Operator operator, VMExpression ex) {
		super(node);
	...
	public Collection<IVariable> getDefs() {
		...
		if (operator.equals(Operator.DECREMENT)
				|| operator.equals(Operator.INCREMENT))
